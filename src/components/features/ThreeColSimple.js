...
export default ({
  ...
  return (
    <Container
    >
      <ContentWithPaddingXl style={{paddingBlock:'26px'}}>
        ...
        <Column className="cardita" style={{backgroundColor:'rgb(237 242 247 / 1)', borderRadius:'5%', marginBottom:'9px'}}>
            <Card href={"www.youtube.com"}>
              <span className="imageContainer" css={imageContainerCss}>
                <img src={YoutubeIcon} alt="" css={imageCss} />
              </span>
          ...
          <Column className="cardita" style={{backgroundColor:'rgb(237 242 247 / 1)', borderRadius:'5%', marginBottom:'9px'}}>
            <Card href={"www.tiktok.com"}>
              <span className="imageContainer" css={imageContainerCss}>
                <img src={TikTokIcon} alt="" css={imageCss} />
              </span>
              <span className="title">Tik Tok</span>
          ...
          <Column className="cardita" style={{backgroundColor:'rgb(237 242 247 / 1)', borderRadius:'5%', marginBottom:'9px'}} >
            <Card href={"www.instagram.com"}>
              <span className="imageContainer" css={imageContainerCss}>
                <img src={Instagram} alt="" css={imageCss} />
              </span>
